...
/**
 * OpenSearch plugin for reading external Apache Iceberg tables via the analytics engine.
 *
 * <p>Handles only Plugin lifecycle (REST handlers, named writeables, shutdown).
 * Schema contribution and query execution are handled by {@link IcebergSchemaContributor}
 * and {@link IcebergTableExecutor}, discovered separately via SPI.
 */
